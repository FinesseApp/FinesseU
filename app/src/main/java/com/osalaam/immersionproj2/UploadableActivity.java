...
public class UploadableActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private String mType = "Homework"; // will be intent

    private String mClass;


    private String mAuthor = "Jason Ogato"; // will be intent
   // private String mRating = "5";
    private String mTitle = "Jasons Moustache"; // will be intent
   // private String mURL = "www.google.com";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference examRef =  mDatabaseReference.child("Exams");
    ...
    private void uploadFile(){
        ...
        if (filePath != null)
        {
            ...
            StorageMetadata metadata = new StorageMetadata.Builder()
                    ...
                    .setCustomMetadata("teacher", mAuthor).setCustomMetadata("class", mClass).setCustomMetadata("type", mType).setCustomMetadata("title", mTitle)
                    .build();
...
*/
            ...
            relevantRef.putFile(filePath, metadata)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            //  mDatabaseReference.push();
                                ...
                                ResourceObj newHW = new ResourceObj(mAuthor, mClass, mTitle, downloadUrl.toString(), "BLAH");
